...
const SliderThumb = () => (
  <div className="flex items-center justify-center w-10 h-10 rounded-full bg-[#10D5C2] group hover:bg-[#7AEADF] transition-colors shadow-lg shadow-[#10D5C2]/30">
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 overflow-hidden relative">
      <div className="absolute inset-0">
        <div className="w-full h-1/2 bg-[#F1F5FE]" />
        <div className="w-full h-1/2 bg-gradient-to-b from-[#F1F5FE] to-white" />
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-[#E5EAF5] rounded-full opacity-50 blur-3xl"></div>
        <div className="absolute top-20 right-1/4 w-[400px] h-[400px] bg-[#E5EAF5] rounded-full opacity-50 blur-3xl"></div>
      </div>
